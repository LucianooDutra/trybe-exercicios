...
# verificar o número de servidores que se comunicam. Os servidores estão
# representados como um array bidimensional onde o valor 1 representa um
# computador e 0 a ausência do mesmo. Dois servidores se comunicam se eles
# estão na mesma linha ou mesma coluna.
