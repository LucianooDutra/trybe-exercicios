# Exercício 4 Você têm dois arrays de números inteiros que representam: (I)
# instantes
# de entrada e saídas em uma biblioteca (II) um número que represente um
# instante
# a ser buscado. Retorne quantas pessoas estudantes estão na biblioteca naquele
