# Exercício 2 Suponha que se está escrevendo uma função para um jogo
# de batalha naval. Dado um array bidimensional com n linhas
# e m colunas, e um par de coordenadas x para linhas e y para colunas,
